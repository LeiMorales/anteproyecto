...
Nuestra plataforma está diseñada para quienes desean tomar el control de su dinero, desde jóvenes que buscan independencia y trabajadores informales, hasta nómadas digitales con ingresos variables. El objetivo es fomentar hábitos sostenibles mediante educación económica, opciones de inversión y asesoría personalizada con machine learning. Nos enfocamos en la población de Bogotá, conectando a los usuarios con las oportunidades y condiciones financieras específicas de la ciudad.

\subsubsection*{Oferta}
\addcontentsline{toc}{subsubsection}{Oferta}
Nuestra plataforma busca ofrecer una plataforma \textit{freemium}, en la cual se permita al usuario utilizar la plataforma de forma gratuita con la opción de hacer una suscripción mensual para tener mayor acceso a las características de la plataforma y eliminar los anuncios de la versión gratuita.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm]{Imagenes/PasosInboundMarketing.jpeg}
	\caption[{Pasos del Inbound Marketing.}]{\centering Pasos del Inbound Marketing. \textit{Fuente:} Importancia de la diferenciación en estrategias de Inbound Marketing, Bases G., 2024, Origen: https://es.linkedin.com/pulse/importancia-de-la-diferenciación-en-estrategias-inbound-gonzalo-bases-cojgff}
	\label{fig:pasosinboundmarketing}
\end{figure}

Las 4 fases de estas estrategias de marketing de acorde a \textcite{Hubspot01} son las siguientes:
...
\begin{itemize}
	...
	\item \textbf{Convertir:} Una vez que se haya logrado captar la atención de los clientes potenciales y lleguen a nuestra plataforma digital, los convertiremos en usuarios registrados al ofrecerles herramientas personalizadas y experiencias altamente relevantes. En las cuales los visitantes podrán acceder a simuladores financieros interactivos gratuitos, calculadoras de presupuesto, personalización de la ruta de aprendizaje y un contenido educativo progresivo en base al conocimiento de educación financiera que poseen.
...
Como expresamos, nuestro modelo de negocio incluirá servicios gratuitos de la misma forma que la opción de un modelo de suscripción mucho más avanzado, por lo cual, el precio mensual de la suscripción sería el siguiente:
