...
\begin{itemize}
	\item \textbf{Socios:} Leidy Marcela Morales Segura con Cédula de Ciudadanía No. 1013649393 y David Leonardo Rincón Ovalle con Cédula de Ciudadanía No. 1001093774.
...
\begin{itemize}
	\item \textbf{Norma Técnica Colombiana (NTC) ISO 9000:} Describe los fundamentos de los sistemas de gestión de la calidad y establece la terminología asociada a estos sistemas. Esta norma es fundamental para garantizar la comprensión y correcta implementación de los principios de calidad, orientados a la satisfacción del cliente \parencite{ISO9000}.
	
	\item \textbf{Norma ISO 9001:} Es el estándar internacional de gestión de la calidad más ampliamente aplicado a nivel mundial. Define los requisitos para la implementación de procesos y procedimientos orientados a lograr la satisfacción del cliente. La certificación ISO 9001 demuestra el compromiso de EduFinanzas con la calidad, la consistencia y la mejora continua \parencite{ISO9001}.
	
	\item \textbf{Norma ISO 10008:} Es un estándar internacional enfocado en la gestión de la satisfacción del cliente en el comercio electrónico. Proporciona directrices para implementar prácticas que protejan la información y los datos de los clientes en las transacciones digitales \parencite{ISO10008}.
	
	\item \textbf{Norma ISO/IEC 20000:} Es un estándar internacional para la gestión de servicios de tecnologías de la información, cuyo objetivo es garantizar la calidad, eficiencia y mejora continua en la prestación de servicios de TI. Permite asegurar que los servicios tecnológicos estén alineados con los requisitos del negocio y de los clientes \parencite{ISO20000}.
	
	\item \textbf{Norma ISO 22301:} Es un estándar internacional para la gestión de la continuidad del negocio, que busca garantizar la operación continua de la organización ante desastres o situaciones críticas. Es fundamental para fortalecer la resiliencia organizacional \parencite{ISO22301}.
	
	\item \textbf{Norma ISO/IEC 27001:} Es un estándar de seguridad de la información que busca garantizar la protección de la información y los datos de nuestro clientes. Esta norma es esencial para proteger la información y datos de EduFinanzas \parencite{ISO27001}.
	
	\item \textbf{Norma ISO/IEC 27002:} Es un estándar internacional de seguridad de la información que proporciona directrices y buenas prácticas para la implementación de controles de seguridad dentro de una organización, con el fin de proteger la confidencialidad, integridad y disponibilidad de la información \parencite{ISO27002}.
\end{itemize}
